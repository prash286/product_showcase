          ...
          <div className="overflow-y-auto flex-1 relative">
            ...
            {showModal ? (
              <div className="absolute top-0 bottom-0 left-0 right-0 backdrop-blur-md bg-[rgba(0,0,0,0.25)]">
                <div className="max-w-[50%] min-w-80 mx-auto bg-white h-full relative">
                  {!loading2 && Object.keys(selectedProductDetails).length ? (
                    <>
                      ...
                      <img
                        ...
                        alt=""
                        className="w-full h-56 object-scale-down mb-2 rounded-t "
                      />
                      <div className="px-6 py-4">
                        ...
                        <div className="py-2 self-end">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <button className="rounded-3xl px-3 py-2 bg-yellow-500 font-medium cursor-pointer">
                              Add to cart
                            </button>
                          </div>
                        </div>
